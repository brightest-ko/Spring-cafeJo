...
<div class="container">
  <form class="form-horizontal" action="<%= request.getContextPath() %>/menu/addmenu.do"
  method="post" enctype="multipart/form-data" onsubmit="return addmenuFormCheck()">
  <h2 class="text-center">상품추가</h2>
  ...
  <table class="table">
  	...
  	<tr>
  		<th>상품 명</th>
  		<td><input class="form-control" id="menuname" name="menuname" type="text" placeholder="상품명을 입력하세요." required="required"></td>
  	</tr>
  	<tr>
  		<th>구분</th>
  		<td>
    ...
    <label class="radio-inline"><input type="radio" name="hotncold" value="COLD">COLD</label>
  	...
  	<tr>
  		<th>제품 설명</th>
  		<td>
  		<textarea class="form-control" style="resize:none" cols="50" rows="5" id="description" name="description" placeholder="제품 설명을 입력하세요." required="required"></textarea>
  		</td>
  	</tr>
  	<tr>
  		<th>열량(kcal)</th>
  		<td><input class="form-control" id="calory" name="calory" type="text" placeholder="열량을 입력하세요." required="required"></td>
  	</tr>
  	<tr>
  		<th>당류(g)</th>
  		<td><input class="form-control" id="saccharide" name="saccharide" type="text" placeholder="당 양을 입력하세요." required="required"></td>
  	</tr>
  	<tr>
  		<th>단백질(g)</th>
  		<td><input class="form-control" id="protein" name="protein" type="text" placeholder="담백질 양을 입력하세요." required="required"></td>
  	</tr>
  	<tr>
  		<th>카페인(mg)</th>
  		<td><input class="form-control" id="caffeine" name="caffeine" type="text" placeholder="카페인 양을 입력하세요." required="required"></td>
  	</tr>
  	<tr>
  		<th>포화지방(g)</th>
  		<td><input class="form-control" id="fat" name="fat" type="text" placeholder="포화지방 양을 입력하세요." required="required"></td>
  	</tr>
  	<tr>
  		<th>나트륨(mg)</th>
  		<td><input class="form-control" id="sodium" name="sodium" type="text" placeholder="나트륨 양을 입력하세요." required="required"></td>
  	</tr>
  	<tr>
  		<th>이미지</th>
  	...
  	<tr>
  		<td colspan="2">
  		<button type="submit" class="btn btn-danger col-md-offset-3 col-xs-2">추가하기</button>
