...
<div class="container">
  ...
  <div class="col-md-6 col-md-offset-3">
    <div class="signfrm text-center">
		...
		<p class="text-center">회원님의 명의로 가입된 아이디의 임시 비밀번호는 아래와 같습니다.</p>
		<p class="text-center">개인정보 보호를 위해 비밀번호를 변경해주시기 바랍니다.</p>
		<hr>
		<c:if test="${not empty usernewpasswd}">
		${usernewpasswd}
		<br>
		<br>
		...
		<c:if test="${empty usernewpasswd}">
		일치하는 회원정보가 없습니다. <br>회원가입 하시겠습니까?
		<br>
		<br>
		<button class="btn btn-danger"
